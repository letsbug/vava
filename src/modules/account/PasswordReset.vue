  ...
  <div class="container-login--password">
    <div class="form-login--password">
      ...
      <el-form v-if="step === 1" ref="formAccount" :model="form" :rules="rules">
        <p>
          <strong>Please enter your account binding email address or phone number.</strong>
        </p>
      ...
      <el-form v-if="step === 1" ref="formSecurityCode" :model="form" :rules="rules">
        <el-form-item prop="securityCode">
          <el-input
            ...
            size="large"
            name="securityCode"
            class="input-security__code"
            type="text"
            placeholder="Security code"
          >
            <a
              slot="suffix"
              :class="timing ? 'disabled' : ''"
              class="link-theme handle-get__code"
      ...
      <el-form v-if="step === 2" ref="confirmPassword" :model="form" :rules="rules">
        <p>
          <small>Password must be a combination of Numbers and letters, and between 8 and 16 characters.</small>
        </p>
        ...
        <el-form-item prop="confirm">
          <el-input
            ...
            :type="pwdType.confirm ? 'password' : 'text'"
            size="large"
            name="password"
            placeholder="Confirm"
          >
...
export default class extends Vue {
  ...
  private validName(r: any, v: string, c: Function) {
    if (!v || isEmpty(v)) {
  ...
  private validConfirm(r: any, v: string, c: Function) {
