...
export default {
  ...
  data() {
    return {
      content: `
        <p><img style="float: right;" src="./static/tinymce/images/glyph-tinymce@2x.png" alt="TinyMCE" height="150px" data-mce-src="images/glyph-tinymce@2x.png" data-mce-style="float: right;"></p>
